...
namespace SplashKitSDK
{
  public static class SplashKit
  {
    ...
    [DllImport("splashkit.dll", CallingConvention=CallingConvention.Cdecl, EntryPoint="__sklib__audio_jumping", CharSet=CharSet.Ansi)]
    private static extern int __sklib__audio_jumping();
    ...
    public static bool Audiojumping()
    {
      int __skreturn;
      __skreturn = __sklib__audio_jumping();
      return __skadapter__to_bool(__skreturn);
    }
...
public static class Audio{
    ...
    {
        get { return SplashKit.Audiojumping(); }
    }
}
